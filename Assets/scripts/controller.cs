...
public class controller : MonoBehaviour
{
    ...
    private void calculateEnginePower(){
        ...
        wheelRPM();
            ...
            if (vertical != 0 ){
            carRigidbody.linearDamping = 0.005f; 
            }
            if (vertical == 0){
    ...
    private void moveVehicle(){
        ...
        KPH = carRigidbody.linearVelocity.magnitude * 3.6f;
    ...
    private void addDownForce(){
        ...
        carRigidbody.AddForce(-transform.up * DownForceValue * carRigidbody.linearVelocity.magnitude );
    ...
    private void adjustTraction(){
		...
		if(IM.handbrake){
            ...
            carRigidbody.AddForce(transform.forward * (KPH / 400) * 10000 );
		}
    ...
    public void activateNitrus(){
        ...
        if (IM.boosting){
            if (nitrusValue > 0) { 
                ...
                carRigidbody.AddForce(transform.forward * 5000);
            } 
